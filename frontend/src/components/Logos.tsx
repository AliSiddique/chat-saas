...
const MarqueeLogos = () => {
  return (
    <div className=" rounded-lg h-full w-full relative flex justify-center items-center bg-background overflow-hidden py-20 flex-col gap-4">
      <Marquee pauseOnHover={true} reverse className="[--gap:3rem]">
        {logos.map((logo, idx) => (
          <Logo key={idx} {...logo} />
        ))}
      </Marquee>
